    ...
    public class ContaController : Controller
    {
        ...
        private async Task EnviarEmailDeConfirmacaoAsync(UsuarioAplicacao usuario)
        {
            ...
            await UserManager.SendEmailAsync(
                usuario.Id,
                "OrisCenter Key - Confirmação de Email",
                $"Bem vindo ao OrisCenter Key, clique aqui {linkDeCallback} para confirmar seu email!");
        }
        ...
        public async Task<ActionResult> EsqueciSenha(ContaEsqueciSenhaViewModel modelo)
        {
            if (ModelState.IsValid)
            {
                ...
                if (usuario != null)
                {
                    ...
                    await UserManager.SendEmailAsync(
                        usuario.Id,
                        "OrisCenter Key - Alteração de senha",
